...
export interface VenueLightingEvent {
  id: string
  tick: number
  type: string
}

export interface VenuePostProcessingEvent {
  id: string
  tick: number
  type: string
}

export interface VenueStageEvent {
  id: string
  tick: number
  effect: string
  flags?: string[]
...
export interface VenuePerformerEvent {
  id: string
  tick: number
  duration: number
  type: string
...
export interface VenueCameraCutEvent {
  id: string
  tick: number
  subject: string
}
...
export interface VenueTrackData {
  ...
  lighting: VenueLightingEvent[]
  postProcessing: VenuePostProcessingEvent[]
  stage: VenueStageEvent[]
  performer: VenuePerformerEvent[]
  cameraCuts: VenueCameraCutEvent[]
}
...
// Lane markers — span-based decorative/gameplay overlays on instrument tracks
// e.g. drum rolls, tremolo, trill, BRE, disco flip
export type LaneMarkerType = 'drumRoll' | 'tremolo' | 'trill' | 'bre' | 'discoFlip'
...
// Global chart song sections (arrangement markers like verse/chorus)
...
export interface UIState {
  ...
  selectedVenueEvent: SelectedVenueEventRef | null
